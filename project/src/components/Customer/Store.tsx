...
const Store: React.FC = () => {
  ...
  const addToCart = (productId: string) => {
    ...
    // Trigger navbar/cart pulse animation
    try {
      ...
      await initiatePayment({
        ...
        handler: async (response: RazorpayResponse) => {
          try {
            ...
            setProcessing(false);
            alert(
              "Payment successful! Order placed successfully. Check your dashboard for tracking details."
            );
          } catch {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 via-purple-50 to-rose-50 ">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://res.cloudinary.com/dwb3vztcv/image/upload/v1756495970/Art_and_slime_DIY_KITS_1_ak4ljm.png')",
          height: "350px",
            ...
            <main className="lg:col-span-3">
              <div className="mb-8">
                ...
                <p className="text-gray-600">
                  Showing {availableProducts.length} of {products.length}{" "}
                  products
                </p>
              </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="relative w-full aspect-square overflow-hidden">
                          ...
                          {product.badge && (
                            <div
                              className={`absolute top-4 left-4 px-3 py-1 rounded-full text-white text-xs font-bold shadow-lg bg-purple-600`}
                            >
                              {product.badge}
                            </div>
                          )}
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex items-center justify-between mt-3">
                            {/* Moved purple price to bottom and styled prominently */}
              ...
              <div className="bg-gradient-to-br from-white via-purple-50 to-rose-50 p-12 rounded-3xl shadow-xl border border-purple-100 mt-12">
                <div className="text-center max-w-2xl mx-auto">
                  ...
                  <p className="text-gray-600 mb-8 text-lg leading-relaxed">
                    We offer special discounts on bulk purchases for parties,
                    corporate events, and gifting. Get in touch with us for a
                    custom quote and exclusive deals!
                  </p>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <button
                      className="group  text-white font-semibold px-8 py-4 rounded-full hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
                      style={{ backgroundColor: "#7F55B1" }}
                    >
