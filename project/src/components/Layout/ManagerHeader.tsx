        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="flex items-center justify-between h-16 sm:h-[86px]">
            ...
            <div className="hidden md:flex md:items-center md:gap-4">
              ...
              <Link to="/manager" className={`${linkBase} ${isActive(['/manager']) ? activeLink : ''}`}>DASHBOARD</Link>
            </div>
        ...
        {open && (
          <div className="md:hidden border-t border-gray-100 bg-white">
            <div className="px-4 py-3 space-y-1">
              ...
              <Link onClick={() => setOpen(false)} to="/manager" className={`${linkBase} block ${isActive(['/manager']) ? activeLink : ''}`}>DASHBOARD</Link>
              {user && (
                <button
